...
export function WorkspaceSwitcher() {
    ...
    // Identical placeholder on server + first client paint
    if (!mounted || loading || workspaces.length === 0) {
        return (
            <div className="h-9 w-40 animate-pulse rounded-md bg-slate-100" aria-hidden />
        );
    }
