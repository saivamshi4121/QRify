...
User-Agent: Qrezo-Webhooks/1.0`}</pre>
            ...
            <section id="replay" className="space-y-3">
                <h2 className="text-xl font-semibold text-slate-900">Replay</h2>
                <p className="text-sm text-slate-700">
            ...
            <section id="events" className="space-y-3">
                ...
                <pre className="overflow-auto rounded-lg bg-slate-50 p-4 text-xs text-slate-800">{`event.created | event.updated | event.deleted
  ...
  "data": {
    ...
    "email": "ada@example.com"
            ...
            <section id="verify" className="space-y-3">
                ...
                <h3 className="font-medium text-slate-800">TypeScript / Node.js</h3>
...
function verify(secret: string, header: string, rawBody: string) {
  ...
  return crypto.timingSafeEqual(
    ...
    Buffer.from(expected)
                ...
                <h3 className="font-medium text-slate-800">Python</h3>
