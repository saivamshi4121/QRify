...
import { regenerateCredential } from "@/modules/event-credential/service";
...
export async function POST(_request: Request, { params }: RouteParams) {
    try {
        ...
        const credential = await regenerateCredential(
            workspaceId,
            eventId,
            publicId
        );
        ...
        return handleApiError(error, "Regenerate Credential Error");
    }
}
