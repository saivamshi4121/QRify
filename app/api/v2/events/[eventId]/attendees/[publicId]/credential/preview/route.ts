...
import { previewPNG } from "@/modules/event-credential/service";
...
export async function GET(_request: Request, { params }: RouteParams) {
    try {
        ...
        const buffer = await previewPNG(workspaceId, eventId, publicId);
        ...
        return handleApiError(error, "Preview Credential Error");
    }
}
